...
export default function Home() {
  const data = useStaticQuery(graphql`
    query {
      ...
      bkg: file(relativePath: { regex: "/bg_main/"}) {
        sharp: childImageSharp {
  ...
  return (
    <div>
        ...
        <div className="row">
          <div className="container d-flex align-items-center justify-content-between">
            ...
            <ul className="nav-menu list-unstyled">
              ...
              <li>
                <a href="#philosophies" className="smoothScroll">
                  Philosophies
                </a>
              </li>
              <li>
                <a href="#ce" className="smoothScroll">
                  Education
                </a>
              </li>
              <li>
                <a href="#skills" className="smoothScroll">
                  Skills
                </a>
              </li>
              <li>
      ...
      <div
        id="education"
        className="paddsection bg-light-gray"
      ...
      <div id="skills" className="text-left paddsection">
        <div className="container">
